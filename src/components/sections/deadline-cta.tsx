      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 py-32 md:grid-cols-2 md:gap-24 md:px-16">
        ...
        <div>
          <p className="mb-10 text-sm leading-loose text-[#4A5668]">
            ...
            or 3% of global annual turnover. Meanwhile Singapore&apos;s MAS FEAT already applies today,
            Indonesia&apos;s OJK has published AI governance guidance for banks (non-binding, but built on
            binding IT-governance rules), and UAE&apos;s DFSA is consulting on AI rules through mid-2026.
          </p>
          <a
            href="#get-key"
            className="inline-block rounded-full bg-[#f0ebe0] px-7 py-3 text-sm font-semibold text-[#1a1a1a] transition-all hover:bg-[#e8dfd0] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f0ebe0]/60"
          >
